# Clima App - Weather App

**ES:** _Este fue un ejercicio con (html, tailwind y js) para obtener el clima de una ciudad en especifico por medio de la API OpenWeather._\
